...
public class ChangeBioFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        etChangeBioLine = view.findViewById(R.id.etChangeBioLine);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String bio = etChangeBioLine.getText().toString().trim();
                databaseReference.child("bio").setValue(bio).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
